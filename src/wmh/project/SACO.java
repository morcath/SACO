...
public class SACO {
    ...
    public void execute()
    {
        ...
        while(!end)
        {
            ...
            //wi�kszo�� mr�wek pod��a t� sam� �cie�k�
            if(!end && p > 0.5)
            {
            	//�cie�ki wyznaczone przez wszystkie mr�wki w bie��cej iteracji
	            ...
	            for(int i = 0; i < antsNum; i++)
	            {
	            	...
	            	{
	            		System.out.println("Warunek stopu: wi�kszo�� mr�wek pod��a t� sam� �cie�k�");
	            		end = true;
	            		break;
	            	}
	            }
    ...
    public void displayBestSolution()
    {
    	...
    	{
    		System.out.println("Nie uda�o si� znalezc �adnego rozwi�zania");
    		return;
    	}
